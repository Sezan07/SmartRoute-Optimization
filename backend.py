...
def get_traffic_info(lat1, lon1, lat2, lon2):
    url = f'https://api.mapbox.com/directions/v5/mapbox/driving/{lon1},{lat1};{lon2},{lat2}?alternatives=false&geometries=geojson&steps=false&access_token=pk.eyJ1IjoiYW5zaDE2NCIsImEiOiJjbTZsdW5qdG4wY24zMmxzbXh5dHBtNmt6In0.B1LAHhtVffJ0uuif4VJ1gw'
...
population = generate_init_population(50, time_slot)
